...
* Allows for **configuration injection** at container startup. Such configuration can be stream in as part of the deployment specification, mounted in from executor hosts or fetched via API calls by the controllers or executors.
